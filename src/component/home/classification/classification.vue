		...
		<ul>
			<li>
				<router-link to='/classify'>
					<span class="backimg1"></span>
					<span>家电厨卫</span>
				</router-link>
			</li>
			<li>
				<router-link to='/classify'>
					<span class="backimg2"></span>
					<span>手机数码</span>
				</router-link>
			</li>
			<li>
				<router-link to='/classify'>
					<span class="backimg3"></span>
					<span>食品饮料</span>
				</router-link>
			</li>
			<li>
				<router-link to='/classify'>
					<span class="backimg4"></span>
					<span>房车家装</span>
				</router-link>
			</li>
			<li>
				<router-link to='/classify'>
					<span class="backimg5"></span>
					<span>服装鞋帽</span>
				</router-link>
			</li>
			<li>
				<router-link to='/classify'>
					<span class="backimg6"></span>
					<span>生活服务</span>
				</router-link>
			</li>
			<li>
				<router-link to='/integral_detail/1'>
					<span class="backimg7"></span>
					<span>积分专区</span>
				</router-link>
			</li>
			<li>
				<router-link to='/brand_list/0'>
					<span class="backimg8"></span>
					<span>品牌</span>
				</router-link>
			</li>
			<li>
				<router-link to='/activity'>
					<span class="backimg9"></span>
					<span>活动</span>
				</router-link>
			</li>
			<li>
				<router-link to='/around'>
					<span class="backimg10"></span>
					<span>周边</span>
				</router-link>
			</li>
		</ul>
